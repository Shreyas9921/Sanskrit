    ...
    <>
      <div className="bg-white-A700 flex flex-col font-poppins items-center justify-start mx-auto w-full">
        <header className="flex items-center justify-center md:px-5 w-full">
          <div
            className="common-pointer bg-white-A700 flex flex-row items-center justify-center p-[17px] w-full"
              ...
              <div className="absolute flex flex-col h-full inset-y-[0] items-center justify-start my-auto right-[0] w-[69%]">
                <div className="flex flex-col items-center justify-start w-full">
                  ...
                  <div className="flex md:flex-col flex-row md:gap-5 items-center justify-evenly w-full">
                    ...
                    >
                      <Img
                        className="common-pointer absolute bottom-[0] h-12 inset-x-[0] mx-auto w-[36%]"
